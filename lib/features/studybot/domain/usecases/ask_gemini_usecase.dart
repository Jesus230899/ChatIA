...
class AskGeminiUseCase implements UseCase<String, String> {
  final StudybotRepository repository;

  AskGeminiUseCase({required this.repository});

  @override
  Future<Either<OperationFailure, String>> call(String params) async {
    final result = await repository.askGemini(prompt: params);
    return result;
  }
}
