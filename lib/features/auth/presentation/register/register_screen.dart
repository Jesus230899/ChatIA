...
import 'package:chatia/features/auth/presentation/widgets/auth_loader_widget.dart';
import 'package:chatia/features/auth/presentation/widgets/auth_messages_widget.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget _body() {
    return Stack(
      children: [
        _content(),
        AuthLoaderWidget(loading: bloc.state.loading),
      ],
    );
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                AuthMessagesWidget(
                  title: 'Registrarse',
                  subtitle: "Por favor, registrate para poder usar la app",
                ),
